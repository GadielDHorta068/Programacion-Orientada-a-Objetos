...
import org.deneb.tp1.ejercicio2.modelo.*;
...
public class TestFerreteria2 {
	...
	@Before
	public void antesDelTest() throws StockInsuficienteException, ArticuloRepetidoException {
	...
	public void articuloIngresado() throws StockInsuficienteException, ArticuloRepetidoException {
	...
	public void stockInsuficiente() {
		...
		} catch (StockInsuficienteException | ArticuloRepetidoException e) {
