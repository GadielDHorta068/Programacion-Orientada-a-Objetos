...
import org.deneb.tp2GUI.ejercicio2.MiFigura;
import org.deneb.tp2GUI.ejercicio2.MiLinea;
import org.deneb.tp2GUI.ejercicio2.MiOvalo;
import org.deneb.tp2GUI.ejercicio2.MiRectangulo;
...
public class FigurasRandom extends JPanel {
    ...
    public FigurasRandom(int numLineas, int numOvalos, int numRectangulos) {
        ...
        figuras = new Figura[numLineas + numOvalos + numRectangulos];
